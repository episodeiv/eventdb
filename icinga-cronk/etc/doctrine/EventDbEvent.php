...
class EventDbEvent extends BaseEventDbEvent
{
	...
	public static function resolveAddress($address) {
		return AgaviContext::getInstance()->getModel("EventDB.EventDBHelper","Cronks")->resolveAddress($address);;
	}

	public function getAddressFromBinary($bin) {
		return AgaviContext::getInstance()->getModel("EventDB.EventDBHelper","Cronks")->getAddressFromBinary($bin);;
	}
	...
	public static function getEventByAddresses(array $addresses = array()) {
		foreach($addresses as &$address) {
			$address = AgaviContext::getInstance()->getModel("EventDB.EventDBHelper","Cronks")->resolveAddress($address);	
		}
		$conn = AgaviContext::getInstance()->getDatabaseManager()->getDatabase('eventdb_r')->getConnection();
