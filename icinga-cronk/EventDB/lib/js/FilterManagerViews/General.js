        ...
        items: [{
            ...
            items: [{
                ...
                items: {
                    ...
                    {
                        boxLabel: 'Syslog',
                        iconCls: 'eventdb_icon syslog', 
                        name: 'src_0'
                    },

                    {
                        boxLabel: 'SNMP',
                        iconCls: 'eventdb_icon smnp', 
                        name: 'src_1'
                    },

                    {
                        boxLabel: 'Mail',
                        iconCls: 'eventdb_icon mail', 
                        name: 'src_2'
                    }
                    ]
                }
            ...
            items: [
            {
                ...
                {
                    boxLabel:'Emergency',
                    ctCls: 'eventdb_tag red', 
                    name:'prio_0'
                },

                {
                    boxLabel:'Alert',
                    ctCls: 'eventdb_tag orange', 
                    name:'prio_1'
                },
                ...
                {
                    boxLabel:'Warning',
                    ctCls: 'eventdb_tag yellow', 
                    name:'prio_4'
                },

                {
                    boxLabel:'Notice',
                    ctCls: 'eventdb_tag green', 
                    name:'prio_5'
                },
            ...
            new Ext.form.CheckboxGroup({
...

                {
                    name: 'facility_0', 
                    id: 'facility_0'+ev_id, 
                    boxLabel : '0 - kernel messages'
                },

                {
                    name: 'facility_1', 
                    id: 'facility_1'+ev_id, 
                    boxLabel : '1 - user-level messages'
                },

                {
                    name: 'facility_2', 
                    id: 'facility_2'+ev_id, 
                    boxLabel : '2 - mail system'
                },

                {
                    name: 'facility_3', 
                    id: 'facility_3'+ev_id, 
                    boxLabel : '3 - system daemons'
                },

                {
                    name: 'facility_4', 
                    id: 'facility_4'+ev_id, 
                    boxLabel : '4 - security1'
                },
...

                {
                    name: 'facility_6', 
                    id: 'facility_6'+ev_id, 
                    boxLabel : '6 - line printer '
                },

                {
                    name: 'facility_7', 
                    id: 'facility_7'+ev_id, 
                    boxLabel : '7 - network news '
                },

                {
                    name: 'facility_8', 
                    id: 'facility_8'+ev_id, 
                    boxLabel : '8 - UUCP subsystem'
                },

                {
                    name: 'facility_9', 
                    id: 'facility_9'+ev_id, 
                    boxLabel : '9 - clock daemon'
                },

                {
                    name: 'facility_10', 
                    id: 'facility_10'+ev_id, 
                    boxLabel : '10 - security2'
                },

                {
                    name: 'facility_11', 
                    id: 'facility_11'+ev_id, 
                    boxLabel : '11 - FTP daemon'
                },

                {
                    name: 'facility_12', 
                    id: 'facility_12'+ev_id, 
                    boxLabel : '12 - NTP subsystem'
                },

                {
                    name: 'facility_13', 
                    id: 'facility_13'+ev_id, 
                    boxLabel : '13 - log audit'
                },

                {
                    name: 'facility_14', 
                    id: 'facility_14'+ev_id, 
                    boxLabel : '14 - log alert'
                },

                {
                    name: 'facility_15', 
                    id: 'facility_15'+ev_id, 
                    boxLabel : '15 - clock daemon'
                },

                {
                    name: 'facility_16', 
                    id: 'facility_16'+ev_id, 
                    ctCls: 'eventdb_tag local0', 
                    boxLabel : '16 - local0'
                },

                {
                    name: 'facility_17', 
                    id: 'facility_17'+ev_id, 
                    ctCls: 'eventdb_tag local1', 
                    boxLabel : '17 - local1'
                },

                {
                    name: 'facility_18', 
                    id: 'facility_18'+ev_id, 
                    ctCls: 'eventdb_tag local2', 
                    boxLabel : '18 - local2'
                },

                {
                    name: 'facility_19', 
                    id: 'facility_19'+ev_id, 
                    ctCls: 'eventdb_tag local3', 
                    boxLabel : '19 - local3'
                },

                {
                    name: 'facility_20', 
                    id: 'facility_20'+ev_id, 
                    ctCls: 'eventdb_tag local4', 
                    boxLabel : '20 - local4'
                },

                {
                    name: 'facility_21', 
                    id: 'facility_21'+ev_id, 
                    ctCls: 'eventdb_tag local5', 
                    boxLabel : '21 - local5'
                },

                {
                    name: 'facility_22', 
                    id: 'facility_22'+ev_id, 
                    ctCls: 'eventdb_tag local6', 
                    boxLabel : '22 - local6'
                },

                {
                    name: 'facility_23', 
                    id: 'facility_23'+ev_id, 
                    ctCls: 'eventdb_tag local7', 
                    boxLabel : '23 - local7'
                }
                ]
            })]
